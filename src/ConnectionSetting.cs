...
namespace Click2Cloud.Samples.AspNetCore.MvcMongoDb
{
    public static class ConnectionSetting
    {
        ...
        private static string mongoDBClusterIP = "172.30.173.157";
        ...
        internal static string CONNECTION_STRING
        {
            get
            {
                ...
                {
                    string _connectionString = string.Format("mongodb://mongouser:newuser123@172.30.173.157:27017/sampledb", MONGODB_USER, MONGODB_PASSWORD,
